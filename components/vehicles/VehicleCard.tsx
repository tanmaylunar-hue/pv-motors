...
export function VehicleCard({ item, variant = "default" }: VehicleCardProps) {
  ...
  if (variant === "minimal") {
    return (
      <Link
        ...
        className="group block h-full bg-background border border-border/40 hover:border-[var(--accent)]/20 hover:shadow-[0_12px_30px_rgba(0,0,0,0.025)] hover:-translate-y-0.5 transition-all duration-300"
      >
        <div className="flex h-full flex-col p-6 sm:p-8">
          <div className="relative mb-6 aspect-[4/3] overflow-hidden border border-border bg-surface transition-colors duration-300 group-hover:border-[var(--accent)]/30">
            <Image
          ...
          <h3 className="font-display text-xl font-medium text-foreground transition-colors duration-300 group-hover:text-[var(--accent)] min-h-[28px] line-clamp-1">
            {item.vehicle}
          </h3>
  ...
  return (
    <Link href={`/vehicles/${item.slug}`} className="group block">
      <Card hover className="h-full hover:border-[var(--accent)]/30">
        <div className="relative mb-4 aspect-[16/10] overflow-hidden border border-border bg-surface transition-colors duration-300 group-hover:border-[var(--accent)]/30">
          <Image
            src={getPrimaryImage(item)}
            alt={`${item.vehicle} ${item.variant}`}
            fill
        ...
        <h3 className="font-display text-lg font-medium text-foreground transition-colors duration-300 group-hover:text-[var(--accent)] min-h-[28px] line-clamp-1">
          {item.vehicle}
        </h3>
